              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {loading
                  ...
                  : [
                      ...
                      renderDetail("City", "Noida Gautam Budh Nagar"),
      ...
      case "job":
        return (
          <div className="bg-white p-4 sm:p-6 rounded-xl shadow">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {renderDetail("Department", userDataList?.department || "---")}
              {renderDetail("Designation", userDataList?.designation || "---")}
              {renderDetail("Date of Joining", userDataList?.doj || "---")}
              {renderDetail("Manager", userDataList?.reportingManager || "---")}
            </div>
          </div>
        );
